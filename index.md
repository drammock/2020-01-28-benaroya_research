...
venue: "Benaroya Research Institute (Room 4 North)"       # brief name of host site without address (e.g., "Euphoric State University")
address: "Room “4 North”, 1201 Ninth Avenue, Seattle, WA"  # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"                              # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"                             # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latitude: "47.603230"                      # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-122.330276"                   # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Jan 28-29, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm"  # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2020-01-28           # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
...
To register for the workshop, please email Kaitlin Flynn (<a href="mailto:kflynn@benaroyaresearch.org">kflynn@benaroyaresearch.org</a>) or Charlie Quinn (<a href="mailto:cquinn@benaroyaresearch.org">cquinn@benaroyaresearch.org</a>).  **Please note that this workshop is for employees of Benaroya Research Institute; it is not open to the general public.** 
